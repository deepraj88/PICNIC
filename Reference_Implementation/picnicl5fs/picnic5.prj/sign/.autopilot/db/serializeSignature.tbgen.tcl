...
set C_modelArgList {
	...
	{ sig_0_challengeBits int 8 regular {array 110 { 1 3 } 1 1 }  }
	{ sig_0_salt int 8 regular {array 32 { 1 3 } 1 1 }  }
	{ sigBytes int 8 regular {array 136176 { 0 3 } 0 1 }  }
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "240749", "Max" : "258707"}
	, {"Name" : "Interval", "Min" : "240749", "Max" : "258707"}
]}
...
set Spec2ImplPortList { 
	...
	sigBytes { ap_memory {  { sigBytes_address0 mem_address 1 18 }  { sigBytes_ce0 mem_ce 1 1 }  { sigBytes_we0 mem_we 1 1 }  { sigBytes_d0 mem_din 1 8 } } }
