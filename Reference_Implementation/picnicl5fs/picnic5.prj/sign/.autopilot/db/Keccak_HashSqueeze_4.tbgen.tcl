...
set C_modelArgList {
	...
	{ data int 8 regular {array 954 { 0 3 } 0 1 }  }
	{ databitlen int 12 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "instance_sponge_stat", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "databitlen", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ databitlen sc_in sc_lv 12 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "databitlen", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "databitlen", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "12", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_KeccakP1600_Permute_s_fu_241.grp_pi_fu_235.crypto_sign_urem_bkb_U4", "Parent" : "10"}]}
...
set Spec2ImplPortList { 
	...
	data { ap_memory {  { data_address0 mem_address 1 10 }  { data_ce0 mem_ce 1 1 }  { data_we0 mem_we 1 1 }  { data_d0 mem_din 1 8 } } }
	databitlen { ap_none {  { databitlen in_data 0 12 } } }
}
