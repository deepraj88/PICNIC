...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "66321"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "66321"}
]}
...
set Spec2ImplPortList { 
	...
	sigBytes { ap_memory {  { sigBytes_address0 mem_address 1 16 }  { sigBytes_ce0 mem_ce 1 1 }  { sigBytes_q0 mem_dout 0 8 }  { sigBytes_address1 mem_address 1 16 }  { sigBytes_ce1 mem_ce 1 1 }  { sigBytes_q1 mem_dout 0 8 } } }
