...
set C_modelArgList {
	{ ctx_RoundKey int 8 regular {array 240 { 1 3 } 1 1 }  }
...
set C_modelType { void 0 }
set C_modelArgList {
	{ ctx_RoundKey int 8 regular {array 240 { 1 1 } 1 1 }  }
	{ buf_r int 8 regular {array 16 { 2 2 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ctx_RoundKey", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set Spec2ImplPortList { 
	ctx_RoundKey { ap_memory {  { ctx_RoundKey_address0 mem_address 1 8 }  { ctx_RoundKey_ce0 mem_ce 1 1 }  { ctx_RoundKey_q0 mem_dout 0 8 }  { ctx_RoundKey_address1 mem_address 1 8 }  { ctx_RoundKey_ce1 mem_ce 1 1 }  { ctx_RoundKey_q1 mem_dout 0 8 } } }
	buf_r { ap_memory {  { buf_r_address0 mem_address 1 4 }  { buf_r_ce0 mem_ce 1 1 }  { buf_r_we0 mem_we 1 1 }  { buf_r_d0 mem_din 1 8 }  { buf_r_q0 mem_dout 0 8 }  { buf_r_address1 mem_address 1 4 }  { buf_r_ce1 mem_ce 1 1 }  { buf_r_we1 mem_we 1 1 }  { buf_r_d1 mem_din 1 8 }  { buf_r_q1 mem_dout 0 8 } } }
}
set moduleName AES_ECB_encrypt
set isTaskLevelControl 1
