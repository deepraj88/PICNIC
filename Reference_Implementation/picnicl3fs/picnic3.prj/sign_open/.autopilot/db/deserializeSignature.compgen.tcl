...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sigBytes \
    op interface \
    ports { sigBytes_address0 { O 17 vector } sigBytes_ce0 { O 1 bit } sigBytes_q0 { I 8 vector } sigBytes_address1 { O 17 vector } sigBytes_ce1 { O 1 bit } sigBytes_q1 { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { params_UnruhGWithout { I 8 vector } } \
} "
}
