...
set C_modelArgList {
	...
	{ sigBytes int 8 regular {array 80084 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ sigBytes_address1 sc_out sc_lv 17 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sigBytes_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "sigBytes", "role": "address1" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "147631"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "147631"}
]}
...
set Spec2ImplPortList { 
	...
	sigBytes { ap_memory {  { sigBytes_address0 mem_address 1 17 }  { sigBytes_ce0 mem_ce 1 1 }  { sigBytes_q0 mem_dout 0 8 }  { sigBytes_address1 mem_address 1 17 }  { sigBytes_ce1 mem_ce 1 1 }  { sigBytes_q1 mem_dout 0 8 } } }
