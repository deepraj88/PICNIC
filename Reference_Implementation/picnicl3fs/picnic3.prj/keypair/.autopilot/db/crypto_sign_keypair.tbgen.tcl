set C_TypeInfoList {{ 
"crypto_sign_keypair" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"pk": [[], {"array": [ {"scalar": "unsigned char"}, [49]]}] }, {"sk": [[], {"array": [ {"scalar": "unsigned char"}, [73]]}] }],["0","1"],""],
 "0": [ "params", [[],"2"],""],
 "1": [ "DRBG_ctx", [[],"3"],""], 
"2": [ "picnic_params_t", {"typedef": [[[], {"scalar": "4"}],""]}], 
"4": [ "picnic_params_t", {"enum": [[],[],[{"PARAMETER_SET_INVALID":  {"scalar": "__integer__"}},{"Picnic_L1_FS":  {"scalar": "__integer__"}},{"Picnic_L1_UR":  {"scalar": "__integer__"}},{"Picnic_L3_FS":  {"scalar": "__integer__"}},{"Picnic_L3_UR":  {"scalar": "__integer__"}},{"Picnic_L5_FS":  {"scalar": "__integer__"}},{"Picnic_L5_UR":  {"scalar": "__integer__"}},{"Picnic2_L1_FS":  {"scalar": "__integer__"}},{"Picnic2_L3_FS":  {"scalar": "__integer__"}},{"Picnic2_L5_FS":  {"scalar": "__integer__"}},{"PARAMETER_SET_MAX_INDEX":  {"scalar": "__integer__"}}],""]}], 
"3": [ "AES256_CTR_DRBG_struct", {"typedef": [[[],"5"],""]}], 
...
set C_modelArgList {
	{ pk int 8 regular {array 49 { 0 3 } 0 1 }  }
	{ sk int 8 regular {array 73 { 0 0 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "pk", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "pk","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 48,"step" : 1}]}]}]} , 
 	{ "Name" : "sk", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "sk","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 72,"step" : 1}]}]}]} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6"],
		...
		"Port" : [
			...
			{"Name" : "DRBG_ctx_reseed_counter", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_picnic_keygen_fu_248", "Port" : "DRBG_ctx_reseed_counter"}]},
	...
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248", "Parent" : "0", "Child" : ["7", "8", "9", "10", "24"],
		...
		"Port" : [
			...
			{"Name" : "DRBG_ctx_reseed_counter", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "24", "SubInstance" : "grp_randombytes_fu_465", "Port" : "DRBG_ctx_reseed_counter"}]},
			{"Name" : "temp_matrix", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
	...
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_LowMCEnc_fu_452", "Parent" : "6", "Child" : ["11", "12", "13", "17", "21", "23"],
		...
		"Port" : [
			...
			{"Name" : "output_r", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "13", "SubInstance" : "grp_matrix_mul_fu_253", "Port" : "output_r"},
					{"ID" : "23", "SubInstance" : "grp_xor_array_fu_282", "Port" : "out_r"},
					{"ID" : "21", "SubInstance" : "grp_xor_array_1_fu_273", "Port" : "in1"}]},
			{"Name" : "key", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "17", "SubInstance" : "grp_matrix_mul_1_fu_262", "Port" : "state"}]},
			{"Name" : "temp_matrix", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "17", "SubInstance" : "grp_matrix_mul_1_fu_262", "Port" : "temp_matrix"}]},
			{"Name" : "temp_matrix2", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "13", "SubInstance" : "grp_matrix_mul_fu_253", "Port" : "temp_matrix2"}]},
			{"Name" : "temp_matrix3", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "21", "SubInstance" : "grp_xor_array_1_fu_273", "Port" : "temp_matrix3"}]}]},
	...
	{"ID" : "13", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_LowMCEnc_fu_452.grp_matrix_mul_fu_253", "Parent" : "10", "Child" : ["14", "15", "16"],
		"CDFG" : "matrix_mul",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "temp_matrix2", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "14", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_LowMCEnc_fu_452.grp_matrix_mul_fu_253.temp_matrix2_U", "Parent" : "13"},
	{"ID" : "15", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_LowMCEnc_fu_452.grp_matrix_mul_fu_253.prod_U", "Parent" : "13"},
	{"ID" : "16", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_LowMCEnc_fu_452.grp_matrix_mul_fu_253.temp_U", "Parent" : "13"},
	{"ID" : "17", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_LowMCEnc_fu_452.grp_matrix_mul_1_fu_262", "Parent" : "10", "Child" : ["18", "19", "20"],
		"CDFG" : "matrix_mul_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "matrix_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "temp_matrix", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "18", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_LowMCEnc_fu_452.grp_matrix_mul_1_fu_262.temp_matrix_U", "Parent" : "17"},
	{"ID" : "19", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_LowMCEnc_fu_452.grp_matrix_mul_1_fu_262.prod_U", "Parent" : "17"},
	{"ID" : "20", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_LowMCEnc_fu_452.grp_matrix_mul_1_fu_262.temp_U", "Parent" : "17"},
	{"ID" : "21", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_LowMCEnc_fu_452.grp_xor_array_1_fu_273", "Parent" : "10", "Child" : ["22"],
		"CDFG" : "xor_array_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "temp_matrix3", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "22", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_LowMCEnc_fu_452.grp_xor_array_1_fu_273.temp_matrix3_U", "Parent" : "21"},
	{"ID" : "23", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_LowMCEnc_fu_452.grp_xor_array_fu_282", "Parent" : "10",
		"CDFG" : "xor_array",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "24", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_randombytes_fu_465", "Parent" : "6", "Child" : ["25", "26", "27", "34", "36"],
		"CDFG" : "randombytes",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"WaitState" : [
			...
			{"State" : "ap_ST_fsm_state12", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_KeyExpansion_fu_399"},
			{"State" : "ap_ST_fsm_state14", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_AES_ECB_encrypt_fu_408"}],
		"Port" : [
			{"Name" : "x", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "DRBG_ctx_V", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "27", "SubInstance" : "grp_AES256_CTR_DRBG_Upda_fu_389", "Port" : "V"}]},
			{"Name" : "sbox", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "27", "SubInstance" : "grp_AES256_CTR_DRBG_Upda_fu_389", "Port" : "sbox"},
					{"ID" : "34", "SubInstance" : "grp_KeyExpansion_fu_399", "Port" : "sbox"},
					{"ID" : "36", "SubInstance" : "grp_AES_ECB_encrypt_fu_408", "Port" : "sbox"}]},
			{"Name" : "DRBG_ctx_Key", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "27", "SubInstance" : "grp_AES256_CTR_DRBG_Upda_fu_389", "Port" : "DRBG_ctx_Key"},
					{"ID" : "34", "SubInstance" : "grp_KeyExpansion_fu_399", "Port" : "Key"}]},
			{"Name" : "DRBG_ctx_reseed_counter", "Type" : "OVld", "Direction" : "IO"}]},
	{"ID" : "25", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_randombytes_fu_465.ctx_RoundKey_U", "Parent" : "24"},
	{"ID" : "26", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_randombytes_fu_465.buffer_assign_U", "Parent" : "24"},
	{"ID" : "27", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_randombytes_fu_465.grp_AES256_CTR_DRBG_Upda_fu_389", "Parent" : "24", "Child" : ["28", "29", "30", "32"],
		...
		"HasNonBlockingOperation" : "0",
		"WaitState" : [
			{"State" : "ap_ST_fsm_state12", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_KeyExpansion_fu_475"},
			{"State" : "ap_ST_fsm_state14", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_AES_ECB_encrypt_fu_484"}],
		"Port" : [
			{"Name" : "V", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "sbox", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "30", "SubInstance" : "grp_KeyExpansion_fu_475", "Port" : "sbox"},
					{"ID" : "32", "SubInstance" : "grp_AES_ECB_encrypt_fu_484", "Port" : "sbox"}]},
			{"Name" : "DRBG_ctx_Key", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "30", "SubInstance" : "grp_KeyExpansion_fu_475", "Port" : "Key"}]}]},
	{"ID" : "28", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_randombytes_fu_465.grp_AES256_CTR_DRBG_Upda_fu_389.ctx_RoundKey_U", "Parent" : "27"},
	{"ID" : "29", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_randombytes_fu_465.grp_AES256_CTR_DRBG_Upda_fu_389.buffer_assign_U", "Parent" : "27"},
	{"ID" : "30", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_randombytes_fu_465.grp_AES256_CTR_DRBG_Upda_fu_389.grp_KeyExpansion_fu_475", "Parent" : "27", "Child" : ["31"],
		"CDFG" : "KeyExpansion",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "Key", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "sbox", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "31", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_randombytes_fu_465.grp_AES256_CTR_DRBG_Upda_fu_389.grp_KeyExpansion_fu_475.sbox_U", "Parent" : "30"},
	{"ID" : "32", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_randombytes_fu_465.grp_AES256_CTR_DRBG_Upda_fu_389.grp_AES_ECB_encrypt_fu_484", "Parent" : "27", "Child" : ["33"],
		...
		"Port" : [
			...
			{"Name" : "sbox", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "33", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_randombytes_fu_465.grp_AES256_CTR_DRBG_Upda_fu_389.grp_AES_ECB_encrypt_fu_484.sbox_U", "Parent" : "32"},
	{"ID" : "34", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_randombytes_fu_465.grp_KeyExpansion_fu_399", "Parent" : "24", "Child" : ["35"],
		"CDFG" : "KeyExpansion",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "Key", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "sbox", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "35", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_randombytes_fu_465.grp_KeyExpansion_fu_399.sbox_U", "Parent" : "34"},
	{"ID" : "36", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_randombytes_fu_465.grp_AES_ECB_encrypt_fu_408", "Parent" : "24", "Child" : ["37"],
		"CDFG" : "AES_ECB_encrypt",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "p_read15", "Type" : "None", "Direction" : "I"},
			{"Name" : "sbox", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "37", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_picnic_keygen_fu_248.grp_randombytes_fu_465.grp_AES_ECB_encrypt_fu_408.sbox_U", "Parent" : "36"}]}
