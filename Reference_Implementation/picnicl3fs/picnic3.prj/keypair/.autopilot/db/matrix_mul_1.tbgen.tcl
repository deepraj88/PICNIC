...
set C_modelArgList {
	{ output_r int 32 regular {array 16 { 0 3 } 0 1 }  }
	{ state int 32 regular {array 8 { 1 3 } 1 1 }  }
	{ matrix_offset int 16 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "output_r", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "matrix_offset", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ state_address0 sc_out sc_lv 3 signal 1 } 
	{ state_ce0 sc_out sc_logic 1 signal 1 } 
	{ state_q0 sc_in sc_lv 32 signal 1 } 
	{ matrix_offset sc_in sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "matrix_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "matrix_offset", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "5390", "Max" : "5390"}
	, {"Name" : "Interval", "Min" : "5390", "Max" : "5390"}
]}
...
set Spec2ImplPortList { 
	...
	state { ap_memory {  { state_address0 mem_address 1 3 }  { state_ce0 mem_ce 1 1 }  { state_q0 mem_dout 0 32 } } }
	matrix_offset { ap_none {  { matrix_offset in_data 0 16 } } }
}
set moduleName matrix_mul_1
set isTaskLevelControl 1
set isCombinational 0
...
set C_modelArgList {
	...
	{ state int 32 regular {array 8 { 1 1 } 1 1 }  }
	{ matrix_offset int 16 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "output_r", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ output_r_we0 sc_out sc_logic 1 signal 0 } 
	{ output_r_d0 sc_out sc_lv 32 signal 0 } 
	{ output_r_address1 sc_out sc_lv 4 signal 0 } 
	...
	{ state_ce0 sc_out sc_logic 1 signal 1 } 
	{ state_q0 sc_in sc_lv 32 signal 1 } 
	{ state_address1 sc_out sc_lv 3 signal 1 } 
...
set Spec2ImplPortList { 
	output_r { ap_memory {  { output_r_address0 mem_address 1 4 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 1 }  { output_r_d0 mem_din 1 32 }  { output_r_address1 mem_address 1 4 }  { output_r_ce1 mem_ce 1 1 }  { output_r_we1 mem_we 1 1 }  { output_r_d1 mem_din 1 32 } } }
	state { ap_memory {  { state_address0 mem_address 1 3 }  { state_ce0 mem_ce 1 1 }  { state_q0 mem_dout 0 32 }  { state_address1 mem_address 1 3 }  { state_ce1 mem_ce 1 1 }  { state_q1 mem_dout 0 32 } } }
	matrix_offset { ap_none {  { matrix_offset in_data 0 16 } } }
}
set moduleName matrix_mul_1
set isTaskLevelControl 1
