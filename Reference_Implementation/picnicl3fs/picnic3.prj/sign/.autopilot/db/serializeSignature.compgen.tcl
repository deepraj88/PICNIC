...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { sig_0_challengeBits_address0 { O 7 vector } sig_0_challengeBits_ce0 { O 1 bit } sig_0_challengeBits_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sigBytes \
    op interface \
    ports { sigBytes_address0 { O 17 vector } sigBytes_ce0 { O 1 bit } sigBytes_we0 { O 1 bit } sigBytes_d0 { O 8 vector } } \
} "
} else {
