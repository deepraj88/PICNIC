...
set C_modelArgList {
	{ proof_0_seed1 int 8 regular {array 7896 { 0 3 } 0 1 }  }
	{ proof_seed1_offset1 int 9 regular  }
	{ proof_0_seed2 int 8 regular {array 7896 { 0 3 } 0 1 }  }
	{ proof_0_inputShare int 32 regular {array 1974 { 0 3 } 0 1 }  }
	{ proof_0_communicatedBits int 8 regular {array 37177 { 0 3 } 0 1 }  }
	{ proof_0_view3Commitment int 8 regular {array 15792 { 0 3 } 0 1 }  }
	{ challenge int 2 regular  }
	{ seeds_seed int 8 regular {array 23688 { 1 3 } 1 1 }  }
	{ views_inputShare int 32 regular {array 5922 { 1 3 } 1 1 }  }
	{ views_communicatedBits int 8 regular {array 111531 { 1 3 } 1 1 }  }
	{ commitments_hashes int 8 regular {array 47376 { 1 3 } 1 1 }  }
}
...
set portList { 
	...
	{ proof_0_view3Commitment_address0 sc_out sc_lv 14 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "proof_0_view3Commitment_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "proof_0_view3Commitment", "role": "address0" }} , 
 	...
 	{ "name": "seeds_seed_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "seeds_seed", "role": "address0" }} , 
 	...
 	{ "name": "views_communicatedBits_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "views_communicatedBits", "role": "address0" }} , 
 	...
 	{ "name": "commitments_hashes_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "commitments_hashes", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_sign_am_adocq_U172", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "424", "Max" : "436"}
	, {"Name" : "Interval", "Min" : "424", "Max" : "436"}
]}
...
set Spec2ImplPortList { 
	proof_0_seed1 { ap_memory {  { proof_0_seed1_address0 mem_address 1 13 }  { proof_0_seed1_ce0 mem_ce 1 1 }  { proof_0_seed1_we0 mem_we 1 1 }  { proof_0_seed1_d0 mem_din 1 8 } } }
	proof_seed1_offset1 { ap_none {  { proof_seed1_offset1 in_data 0 9 } } }
	proof_0_seed2 { ap_memory {  { proof_0_seed2_address0 mem_address 1 13 }  { proof_0_seed2_ce0 mem_ce 1 1 }  { proof_0_seed2_we0 mem_we 1 1 }  { proof_0_seed2_d0 mem_din 1 8 } } }
	proof_0_inputShare { ap_memory {  { proof_0_inputShare_address0 mem_address 1 11 }  { proof_0_inputShare_ce0 mem_ce 1 1 }  { proof_0_inputShare_we0 mem_we 1 1 }  { proof_0_inputShare_d0 mem_din 1 32 } } }
	proof_0_communicatedBits { ap_memory {  { proof_0_communicatedBits_address0 mem_address 1 16 }  { proof_0_communicatedBits_ce0 mem_ce 1 1 }  { proof_0_communicatedBits_we0 mem_we 1 1 }  { proof_0_communicatedBits_d0 mem_din 1 8 } } }
	proof_0_view3Commitment { ap_memory {  { proof_0_view3Commitment_address0 mem_address 1 14 }  { proof_0_view3Commitment_ce0 mem_ce 1 1 }  { proof_0_view3Commitment_we0 mem_we 1 1 }  { proof_0_view3Commitment_d0 mem_din 1 8 } } }
	challenge { ap_none {  { challenge in_data 0 2 } } }
	seeds_seed { ap_memory {  { seeds_seed_address0 mem_address 1 15 }  { seeds_seed_ce0 mem_ce 1 1 }  { seeds_seed_q0 mem_dout 0 8 } } }
	...
	views_communicatedBits { ap_memory {  { views_communicatedBits_address0 mem_address 1 17 }  { views_communicatedBits_ce0 mem_ce 1 1 }  { views_communicatedBits_q0 mem_dout 0 8 } } }
	commitments_hashes { ap_memory {  { commitments_hashes_address0 mem_address 1 16 }  { commitments_hashes_ce0 mem_ce 1 1 }  { commitments_hashes_q0 mem_dout 0 8 } } }
}
set moduleName prove_26
set isTaskLevelControl 1
set isCombinational 0
